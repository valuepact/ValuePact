...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "QuickCoinV2 Launches. zaobi.org qq260682605";
...
//        CTransaction txNew(1, 1393221600, vin, vout, 0);
        ...
        assert(block.hashMerkleRoot == uint256("ff82be68900c631c93321e9d9aa5a459b97a5719e704fd84a3165bb8e7e3fe3d"));
